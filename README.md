...
- Analyze thefts by:
  ...
  - Year  
  - Color  
- Identify theft trends and patterns  
...
- **Dashboard Tool (Power BI or similar)** — visualization  
...
- Theft numbers increased significantly from 2021 to 2022  
- Silver, white, and black vehicles were the top targeted colors  
...
3. Load the data into your BI tool  
4. Recreate or enhance the dashboard  
